                ...
                <div class="col-lg-7">
                    <div class="card">
                        <div class="card-body table-responsive">
                            <h4 class="header-title mb-2">Tambah <?= $title ?></h4>

                            <?= form_open('penawaran/tambah') ?>
                            <div class="form-group">
                                <label for="">Nama Barang</label>
                                <textarea type="text" name="nama_barang" class="form-control" cols="30" rows="10"></textarea>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="text" name="harga" id="harga" autocomplete="off" class="form-control" value="0">
                                        </div>
                            ...
                            <div class="form-group">
                                ...
                                <input type="number" name="penawaran_qty" class="form-control" value="0" min="1" placeholder="Input nama barang">
                                <small class="text-danger"><?= form_error('penawaran_qty') ?></small>
                            </div>

                            <button class="btn btn-success mt-4 float-right" type="submit"><i class="fe-save"></i> Simpan</button>
