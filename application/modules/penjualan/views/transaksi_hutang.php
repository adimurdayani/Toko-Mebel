                    ...
                    <div class="card">
                        <div class="card-body table-responsive">
                            ...
                            <ul class="nav nav-tabs">
                                <li class="nav-item">
                                    <a href="<?= base_url('penjualan/transaksi_cash') ?>" class="nav-link">
                                        Cash
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a href="#hutang" class="nav-link active" data-toggle="tab" aria-expanded="false">
                                        Hutang
                                    </a>
                                </li>
                            </ul>
                            <div class="tab-content">
                                ...
                                <div class="tab-pane show active" id="hutang">
                                                ...
                                                ?>
                                                    <tr>
                                                        ...
                                                        <td class="text-center">
                                                            ...
                                                            <a href="<?= base_url('penjualan/transaksi_hutang/hapus_keranjang/') . base64_encode($gpk->keranjang_id) ?>" class="btn btn-outline-danger hapus" title="Hapus Barang" data-plugin="tippy" data-tippy-placement="top"><i class="fe-trash"></i> </a>
                                                        </td>
                                                    </tr>
                                                <?php endif; ?>
                                            <?php endforeach; ?>
                                    ...
                                    <?php echo form_open("penjualan/transaksi_hutang/kirim_all_penjualan") ?>
                                    <div class="row mt-4">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="date" name="invoice_piutang_jatuh_tempo" class="form-control" required>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="col ml-6">

                                                <input type="hidden" id="angka0" name="angka0" value="<?= $total ?>" readonly>
                                                <h4>Total &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <input type="text" style="border: 0px;" autocomplete="off" id="angka1" name="total" value="<?= $total ?>" readonly></h4>
                                                ...
                                                <div class="row mt-3">
                                                    ...
                                                    <div class="col">
                                                        <div class="input-group">
                                                            ...
                                                            <input type="text" autocomplete="off" id="angka2" name="bayar" value="0" class="form-control" required>
                                                        </div>
                                                    </div>
                                                </div>
            ...
            <div id="edit<?= $edit->keranjang_id ?>" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="display: none;">
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <?php echo form_open("penjualan/transaksi_hutang/edit_data"); ?>
                        <div class="modal-body p-4">
                            ...
                            <div class="form-group mb-3">
                                ...
                                <input type="text" id="keranjang_harga" name="keranjang_harga" class="form-control" value="<?= rupiah($edit->keranjang_harga) ?>" require>
                            </div>

                            <div class="form-group mb-3">
                                <label for="keranjang_qty">Edit QTY <span class="text-danger">*</span></label>
                                <input type="number" id="keranjang_qty" name="keranjang_qty" min="1" class="form-control" value="<?= $edit->keranjang_qty ?>" require>
                            </div>
            ...
            $('.idproduksi').on('click', function() {
                ...
                $.ajax({
                    ...
                    success: function() {
                        ...
                        document.location.href = "<?= base_url('penjualan/transaksi_hutang') ?>";
                    }
                })
            });
