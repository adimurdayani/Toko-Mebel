                            ...
                            <table id="basic-datatable" class="table nowrap w-100">
                                ...
                                <tbody>
                                    ...
                                    foreach ($get_penjualan_invoice as $data) : ?>
                                        <?php if ($data->invoice_piutang == 0) : ?>
                                            <tr>
                                                <td class="text-center">
                                                    <a href="<?= base_url('penjualan/detail_invoice/') . base64_encode($data->penjualan_invoice) ?>" class="btn btn-outline-success" title="Detail Invoice Penjualan" data-plugin="tippy" data-tippy-placement="top"><i class="fe-eye"></i></a>
                                                    <a href="<?= base_url('penjualan/detail_invoice/') . base64_encode($data->penjualan_invoice) ?>" class="btn btn-outline-warning" title="Retur Penjualan" data-plugin="tippy" data-tippy-placement="top"><i class="fe-edit"></i></a>
                                                    <a href="javascript:void(0);" data-target="#edit-kurir<?= $data->invoice_id ?>" class="btn btn-outline-secondary" data-toggle="modal" title="Edit Kurir" data-plugin="tippy" data-tippy-placement="top"><i class="fe-user-plus"></i></a>
                                                    <a href="<?= base_url('penjualan/cetak_nota/') . base64_encode($data->penjualan_invoice) ?>" target="_blank" class="btn btn-outline-primary" title="Cetak Nota" data-plugin="tippy" data-tippy-placement="top"><i class="fe-printer"></i></a>
                                                </td>
                                                <td><?= $no++ ?></td>
