                    ...
                    <div class="page-title-box">
                        <div class="page-title-right">
                            <ol class="breadcrumb m-0">
                                ...
                                <li class="breadcrumb-item"><a href="<?= base_url('penjualan/transaksi_hutang') ?>">Transaksi</a></li>
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-6">
                                <div class="float-right">
                                    ...
                                    <p><b class="text-danger">Kembalian:</b> <span class="float-right"> &nbsp;&nbsp;&nbsp; Rp.<?= rupiah($get_kostumer->invoice_kembali) ?></span></p>
