                    ...
                    <div class="card-box">
                        ...
                        <div class="row mt-3">
                            ...
                            <div class="col-sm-6">
                                ...
                                <address>
                                    ...
                                    <strong>Tipe Pembayaran: </strong> &nbsp; <?php if ($get_kostumer->invoice_tipe_transaksi == 0) : ?>Cash <?php else : ?> Transfer<?php endif; ?>
                                </address>
                            </div> <!-- end col -->
                        </div>
                        <!-- end row -->
                        ...
                        <div class="mt-4 mb-1">
                            <div class="text-right d-print-none">
                                <a href="<?= base_url('penjualan') ?>" class="btn btn-secondary waves-effect waves-light"><i class="fe-arrow-left"></i> Kembali</a>
