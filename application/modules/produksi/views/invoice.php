                ...
                <div class="col-12">
                    <div class="card-box">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="mt-3">
                                    <?php $toko = $this->db->get_where('tb_toko', ['toko_user_id' => $get_produksi->produksi_kasir])->row(); ?>
                                    <h6>Dari</h6>
                                    <address>
                                        <?= $toko->toko_nama ?><br>
                                        <?= $toko->toko_kota ?><br>
                        ...
                        <div class="mt-4 mb-1">
                            <div class="text-right d-print-none">
                                <a href="<?= base_url('produksi/tambah/') ?>" class="btn btn-secondary waves-effect waves-light"><i class="fe-arrow-left"></i> Kembali</a>
