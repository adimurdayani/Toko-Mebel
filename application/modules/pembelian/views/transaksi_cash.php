                    ...
                    <div class="card">
                        <div class="card-body table-responsive">
                            ...
                            <ul class="nav nav-tabs">
                                ...
                                <li class="nav-item">
                                    <a href="<?= base_url('pembelian/transaksi_hutang/') ?>" class="nav-link ">
                                        Hutang
                                    </a>
                                </li>
                            </ul>
                            <div class="tab-content">
                                ...
                                <div class="tab-pane  show active" id="cash">
                                            ...
                                            ?>
                                                <?php if ($k->keranjang_id_kasir == $user_group->group_id) : ?>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <a href="javascript:void(0);" class="btn btn-sm btn-info waves-effect waves-light" title="Edit harga beli" data-plugin="tippy" data-tippy-placement="top" data-toggle="modal" data-target="#hargabeli<?= $k->keranjang_id ?>"><i class="fe-edit"></i></a>
                                    ...
                                    <?php echo form_open("pembelian/transaksi_cash/kirim_all_pembelian") ?>
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <div class="row mt-3">
                                                    ...
                                                    <div class="col">
                                                        <div class="input-group">
                                                            ...
                                                            <input type="text" autocomplete="off" id="angka2" min="0" value="0" name="bayar" class="form-control" required>
                                                        </div>
                                                    </div>
                                                </div>

                                                <p class="text-success mt-3">Sisa Piutang &nbsp;&nbsp;&nbsp;&nbsp; Rp.<input type="text" style="border: 0px;" autocomplete="off" id="angka3" value="" name="kembali" readonly></p>
                                            </div>
                                        </div>
                                    </div>
                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h4 class="modal-title">Edit Harga Beli Persatuan</h4>
                            <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
                        </div>
                        <?php echo form_open("pembelian/transaksi_cash/edit_harga_beli"); ?>
                        <div class="modal-body p-4">

                            <input type="hidden" name="keranjang_id" value="<?= base64_encode($edit->keranjang_id) ?>">
                            <input type="hidden" name="barang_id" value="<?= base64_encode($edit->barang_id) ?>">
                            <div class="form-group mb-3">
                                <label for="keranjang_harga">Harga Beli Persatuan <span class="text-danger">*</span></label>
            ...
            <div id="edit" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="display: none;">
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <?php echo form_open("pembelian/transaksi_cash/edit_no_invoice"); ?>
                        <div class="modal-body p-4">
