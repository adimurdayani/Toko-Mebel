                    ...
                    <div class="card-box">
                        ...
                        <div class="row mt-3">
                            ...
                            <div class="col-sm-6">
                                ...
                                <address>
                                    ...
                                    <abbr title="Phone">P:</abbr> <?= $get_suplier->phone ?>
                                </address>
                            </div> <!-- end col -->
                        </div>
                        <!-- end row -->
                        ...
                        <div class="mt-4 mb-1">
                            <div class="text-right d-print-none">
                                <a href="<?= base_url('pembelian/transaksi_cash/') ?>" class="btn btn-secondary waves-effect waves-light"><i class="fe-arrow-left"></i> Kembali</a>
