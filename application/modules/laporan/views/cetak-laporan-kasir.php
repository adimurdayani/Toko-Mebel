    ...
    <div class="container p-3">
            ...
            <div class="col-md-6">
                <div class="row">
                    <div class="col-md-6">
                        ...
                        <span class="float-right">#<?= $penjualan_kasir_date['penjualan_invoice'] ?></span><br>
                        <strong class="float-right">Tanggal Penjualan</strong><br>
                        <span class="float-right"><?= $penjualan_kasir_date['invoice_tgl'] ?></span>
        ...
        <table class="table table-bordered">
            ...
            <tbody>
                <?php
                $no = 1;
                foreach ($penjualan_kasir as $data) :
