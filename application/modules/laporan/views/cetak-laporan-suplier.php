    ...
    <div class="container p-3">
            ...
            <div class="col-md-6">
                <div class="row">
                    <div class="col-md-6">
                        ...
                        <span class="float-right">#<?= $penjualan_suplier_date['invoice_pembelian'] ?></span><br>
                        <strong class="float-right">Tanggal Pembelian</strong><br>
                        <span class="float-right"><?= $penjualan_suplier_date['invoice_tgl'] ?></span>
        ...
        <table class="table table-bordered">
            ...
            <tbody>
                <?php
                $no = 1;
                foreach ($penjualan_suplier as $data) :
                    ...
                    <tr>
                        ...
                        <td class="text-center"><?= $user->nama_perusahaan ?></td>
