    ...
    <div class="container p-3">
            ...
            <div class="col-md-6">
                <div class="row">
                    <div class="col-md-6">
                        ...
                        <span class="float-right">#<?= $pembelian_detail_date['pembelian_invoice'] ?></span><br>
                        <strong class="float-right">Tanggal Penjualan</strong><br>
                        <span class="float-right"><?= $pembelian_detail_date['pembelian_date'] ?></span>
        ...
        <table class="table table-bordered">
            ...
            <tbody>
                <?php
                $no = 1;
                foreach ($pembelian_detail as $data) :
                ...
                ?>
                    <tr>
                        ...
                        <td class="text-center"><?= $barang->barang_nama ?></td>
            ...
            <tfoot>
                <tr>
                    ...
                    <th class="text-center"><?= $total->barang_qty ?></th>
                </tr>
            </tfoot>
        </table>
    </div>
