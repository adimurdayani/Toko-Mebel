    ...
    <div class="container p-3">
            ...
            <div class="col-md-6">
                <div class="row">
                    <div class="col-md-6">
                        ...
                        <span class="float-right">#<?= $penjualan_transaksi_date['produksi_invoice'] ?></span><br>
                        <strong class="float-right">Tanggal Penjualan</strong><br>
                        <span class="float-right"><?= $penjualan_transaksi_date['created_at'] ?></span>
        ...
        <table class="table table-bordered">
            ...
            <tbody>
                <?php
                $no = 1;
                foreach ($penjualan_transaksi as $data) :
            ...
            <tfoot>
                <tr>
                    ...
                    <th class="text-right"><?= $total->produksi_terjual ?></th>
                </tr>
            </tfoot>
        </table>
    </div>
