                    ...
                    <div class="card">
                        <div class="card-body table-responsive">
                            ...
                            <div class="btn-group mb-2">
                                <a href="<?= base_url('laporan/eksport_barang/laporan_barang_excel') ?>" class="btn btn-light">Export to Excel</a>
                                <a href="<?= base_url('laporan/eksport_barang/laporan_barang_pdf') ?>" target="_blank" class="btn btn-light">Export to PDF</a>
                                ...
                                <tbody>
                                    ...
                                    foreach ($get_barang as $data) : ?>
                                        <tr>
                                            ...
                                            <td class="text-center"><?= $data->barang_terjual ?></td>
