...
class Kategori_produk extends CI_Controller
{
    ...
    public function index()
    {
        if (!$this->ion_auth->logged_in()) {
            ...
            $data['get_kategori'] = $this->db->get('tb_kategori_produk')->result_array();
            $data['get_config'] = $this->db->get('tb_konfigurasi')->row();

            $this->load->view('template/header', $data, FALSE);
            $this->load->view('template/topbar', $data, FALSE);
            $this->load->view('template/sidebar', $data, FALSE);
            $this->load->view('kategori-produk', $data, FALSE);
    ...
    public function tambah()
    {
        ...
        if ($this->form_validation->run() == FALSE) {
            ...
            redirect('master/kategori_produk');
        } else {
            # code...
            $data = [
    ...
    public function hapus($id)
    {
        ...
        $this->db->delete('tb_kategori_produk', ['id' => $getId]);
        $this->session->set_flashdata(
            'success',
            '$(document).ready(function(e) {
                Swal.fire({
    ...
    public function ubahaktif_produk()
    {
