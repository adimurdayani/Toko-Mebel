                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-body table-responsive">
                            ...
                            <form action="<?= base_url('master/kategori_produk/hapus_all/') ?>" method="POST" id="form-delete">
                                    ...
                                    <tbody>
                                        ...
                                        foreach ($get_kategori as $data) : ?>
                                            <tr>
                                                ...
                                                <td class="text-center"><input type="checkbox" class="ubah-kategori-produk" <?= check_kategori_produk($data['status_kategori']) ?> data-kategoriid="<?= $data['id'] ?>" data-statuskategori="<?= $data['status_kategori'] ?>"></td>
                                                <td class="text-center"><?= $data['created_at'] ?></td>
                                                <td class="text-center">
                                                    <a href="javascript:void(0);" data-target="#edit<?= $data['id'] ?>" class="btn btn-sm btn-warning" data-toggle="modal" title="Edit <?= $data['nama_kategori'] ?>" data-plugin="tippy" data-tippy-placement="top"><i class="fe-edit"></i></a>
                                                    <a href="<?= base_url('master/kategori_produk/hapus/') . base64_encode($data['id']) ?>" class="btn btn-sm btn-danger hapus" title="Hapus <?= $data['nama_kategori'] ?>" data-plugin="tippy" data-tippy-placement="top"><i class="fe-trash"></i> </a>
                                                </td>
                                            </tr>
                                        <?php endforeach; ?>
                                    </tbody>
    ...
    <div id="tambah" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="display: none;">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <?php echo form_open("master/kategori_produk/tambah"); ?>
                <div class="modal-body p-4">

                    <div class="form-group mb-3">
                        <label for="nama_kategori">Nama Kategori <span class="text-danger">*</span></label>
                        <input type="text" id="nama_kategori" name="nama_kategori" class="form-control" value="<?= set_value('nama_kategori') ?>" require>
                    </div>
    ...
    <?php foreach ($get_kategori as $edit) : ?>
        <div id="edit<?= $edit['id'] ?>" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="display: none;">
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        <h4 class="modal-title">Edit <?= $edit['nama_kategori'] ?></h4>
                        <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
                    </div>
                    <?php echo form_open("master/kategori_produk/edit"); ?>
                    <div class="modal-body p-4">
                        ...
                        <div class="form-group mb-3">
                            <label for="nama_kategori">Nama Kategori <span class="text-danger">*</span></label>
                            <input type="text" id="nama_kategori" name="nama_kategori" class="form-control" value="<?= $edit['nama_kategori'] ?>" require>
                        </div>
